...
标题“Game Over”居中显示，按钮“Restart”在矩形下方，支持点击事件。
"""
...
class EndPage:
    ...
    def __init__(self, screen_width=800, screen_height=800):
        ...
        self.visible = False  # 默认不显示，等待游戏结束触发
        ...
        # 遮罩表面（半透明黑色）
        self.mask_surface = pygame.Surface((screen_width, screen_height), pygame.SRCALPHA)
        self.mask_surface.fill((0, 0, 0, 128))  # 半透明黑色（alpha=128）
        ...
        self.button_color = (220, 80, 60)      # 红色系
        self.button_hover_color = (240, 100, 80)  # 悬停色
        self.button_active_color = (180, 60, 40)  # 点击色
    ...
    def handle_event(self, event):
        ...
        Returns:
            bool: 如果点击了重新开始按钮并释放，返回True；否则返回False
        """
        if not self.visible:
            return False
